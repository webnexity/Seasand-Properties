...
const ProjectsShowcase = () => {
  ...
  const previousProjects = [
    ...
    },
    {
      ...
      description: "Eco-friendly villas surrounded by lush landscapes and water features."
    },
    {
      id: 3,
      ...
      description: "Modern commercial and residential complex in the heart of the financial district."
    }
  ];
  ...
  const upcomingProjects = [
    {
      ...
      rating: null,
      launchDate: "Q2 2025",
      description: "Twin towers featuring smart home technology and world-class amenities."
    },
    {
      id: 5,
      ...
      rating: null,
      launchDate: "Q4 2025",
      description: "Exclusive beachfront villas with private access to pristine beaches."
    },
    {
      id: 6,
      title: "Green Commons",
      ...
      rating: null,
      launchDate: "Q1 2026",
      description: "Sustainable community living with integrated parks and recreational facilities."
    }
  ];

  const currentProjects = activeTab === "previous" ? previousProjects : upcomingProjects;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover our portfolio of exceptional properties that redefine modern living
          </p>
        </motion.div>
          ...
          <div className="bg-white p-2 rounded-full shadow-lg border border-gray-100">
            {["previous", "upcoming"].map((tab) => (
              <motion.button
                ...
                className="px-8 py-3 rounded-full font-semibold text-lg mx-1 border-2 border-transparent transition-all duration-300 capitalize"
              >
                {tab === "previous" ? "Completed Projects" : "Upcoming Projects"}
              </motion.button>
            ))}
          </div>
        </motion.div>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 flex items-center gap-1">
                        ...
                        {activeTab === "previous" ? "Completed" : "Launch"}
                      </span>
                      <span className="font-semibold">
                        {activeTab === "previous" ? project.completedDate : project.launchDate}
                      </span>
                    </div>
                  </div>
